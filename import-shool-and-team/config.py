...
COOKIE = "domjudge_refresh=1; domjudge_submissionsfilter=%7B%7D; domjudge_submissionview=0; domjudge_refresh=1; domjudge_cid=2; domjudge_scorefilter=%5B%5D; PHPSESSID=8e0lq0it9ivv5kdhreallutosp"  # 使用admin账号登陆的cookie
