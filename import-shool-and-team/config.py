...
COOKIE = "domjudge_refresh=1; domjudge_refresh=1; domjudge_submissionsfilter=%7B%7D; domjudge_scorefilter=%5B%5D; domjudge_submissionview=0; domjudge_refresh=1; domjudge_cid=-1; PHPSESSID=08hgkvrbfsbe5mb5dc80edpsdo"  # 使用admin账号登陆的cookie
